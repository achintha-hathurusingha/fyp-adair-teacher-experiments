"""TEST12: training loop for Models A/F2/T12 x seeds {0,1,2} (9 runs).
...
RESULTS_CSV = TEST12 / "results" / "epoch_metrics.csv"
SEED_SUMMARY_CSV = TEST12 / "results" / "seed_summary.csv"
