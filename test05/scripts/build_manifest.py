"""TEST05: reference TEST03's existing scene manifest (read-only) -- does
NOT regenerate images, per instruction to use the exact TEST03 data.
...
OUT_PATH = TEST05 / "results" / "manifest.csv"
