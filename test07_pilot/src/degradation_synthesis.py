"""TEST07-Pilot: parameter-randomized Rain/Haze/Noise synthesis, modeled on
the TEST05.5-validated methodology (fresh implementation, self-contained,
per the project's directory-isolation convention -- not imported from
test05_5)."""
