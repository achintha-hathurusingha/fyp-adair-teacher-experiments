"""TEST08-C: merge the 9 per-run epoch_metrics_{model}_seed{seed}.csv and
seed_summary_{model}_seed{seed}.csv files into the unified epoch_metrics.csv
and seed_summary.csv.

Usage (on devon, adair-distill env, PINNED, run AFTER all 9 training runs
have finished):
