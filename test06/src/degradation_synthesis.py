"""TEST06: minimal, self-contained degradation synthesis (Rain/Haze/Noise),
independent of test05_5 (per the directory-isolation rule, test06 does not
import from test05_5). Deliberately simple, parameter-randomized reuse of
the same synthesis approach validated in TEST05.5 -- NOT a copy-paste
import, a fresh implementation scoped to this experiment.
"""
