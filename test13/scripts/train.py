"""TEST13: training loop for Models A/F2/T13 x seeds {0,1,2} (9 runs).
...
RESULTS_CSV = TEST13 / "results" / "epoch_metrics.csv"
SEED_SUMMARY_CSV = TEST13 / "results" / "seed_summary.csv"
